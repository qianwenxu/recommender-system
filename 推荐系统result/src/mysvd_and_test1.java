...
public class mysvd_and_test1 {
	...
	public static void train(float gama, float lambda, int nIter) {
		...
		for (int n = 0; n < nIter; n++) {
			...
			System.out.println("bu[0]="+bu[0]+",bu[1]="+bu[1]+",p[0][0]="+p[0][0]);
	...
	public static void predict() throws IOException{
		...
		bw = new BufferedWriter(new FileWriter(new File("doc\\svd_result.txt")));
