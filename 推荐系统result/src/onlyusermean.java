...
public class onlyusermean {
	...
	public static void loadfile() throws NumberFormatException, IOException{
		...
		allmean/=allmeannum;
		System.out.println("所有评分数量："+allallmeannum);
		System.out.println("有效（非零）评分数量："+allmeannum);
	...
	public static void predict() throws IOException{
		...
		bw = new BufferedWriter(new FileWriter(new File("doc\\only_usermean_result111111.txt")));
